...
@interface PlanTableViewController ()<meandelegate>
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSArray *arr = [NSArray arrayWithObjects:@"我的学习计划 ",@"校长信箱", nil];
...
{
    if (indexPath.row == 0) {
        [self.Delegate setPlanControl];
    }
    if (indexPath.row == 1) {
        [self.Delegate setMainControl];
    }
}
/*
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
