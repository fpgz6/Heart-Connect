...
@interface MyAnswerTableViewController ()
    {
...
@implementation MyAnswerTableViewController
-(id)init
    {
        if ([super init]!=nil) {
            self.title= @"我的回复";
...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
    ...
    {
        MyAnswerTableViewCell *cell = [MyAnswerTableViewCell cellWithTableVIew:tableView];
        cell.commentTime.text = [NSString stringWithFormat:@"%@",[CommentArr[indexPath.row] objectForKey:@"answertime"]];
        cell.commentContent.frame = CGRectMake(20, 30, 320, 20);
        cell.commentContent.text = [NSString stringWithFormat:@"%@",[CommentArr[indexPath.row] objectForKey:@"answer"]];
